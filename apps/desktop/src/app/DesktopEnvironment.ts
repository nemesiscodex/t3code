...
const APP_BASE_NAME = "T3 Code V2";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "t3code-v2-dev" : "t3code-v2";
  const legacyUserDataDirName = isDevelopment ? "T3 Code V2 (Dev)" : "T3 Code V2 (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.nemesiscodex.t3code.v2.dev" : "com.nemesiscodex.t3code.v2",
    ),
    linuxDesktopEntryName: resolveLinuxDesktopEntryName(isDevelopment),
    linuxWmClass: isDevelopment ? "t3code-v2-dev" : "t3code-v2",
